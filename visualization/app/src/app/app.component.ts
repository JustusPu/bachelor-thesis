...
export class AppComponent implements OnInit {
  ...
  addLayer(newURL, newHeight) {
    ...
    this.setupCOS.outlines.push({ url: newURL, height: newHeightVal, visible: true });
  ...
  addTagTime() {
    let pos = { x: this.tagCOS.tag.position.x, y: this.tagCOS.tag.position.x, z: this.tagCOS.tag.position.x };
